...
def user_report():
    ...
    hypertention = st.sidebar.slider('hypertention',0,1)
    heart_disease = st.sidebar.slider('Sakit Jantung',0,1)
    avg_glucose_level	 = st.sidebar.slider('Tingkat Glukosa Rata-rata',0,800,240)
